...
<head>
  ...
  <style>
    ...
    .work-container {
      padding: 60px 0;
      flex: 1; /* Pushes content if footer was there, helps with layout */
    }
...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul class="d-none d-lg-flex">
          ...
          <li><a href="#" class="active">Holidaywork</a></li>
  ...
  <!-- Small copyright line instead of full footer -->
  <div class="copyright-mini">
    © 2025 GS St Philippe Neri. All Rights Reserved.
  </div>
  ...
  <script>
    const holidayWorks = [
      {
        id: 1,
        title: "S3 Physics - Mechanics Review",
        description: "Comprehensive review of Newtons laws, work, energy and power for O'Level candidates.",
        tags: ["#Physics", "#S3", "#OLevel"],
        date: "2024-12-15"
      },
      {
        id: 2,
        title: "S6 PCM/PCB Chemistry",
        description: "Organic chemistry synthesis pathways and reaction mechanisms. Required for next term entry.",
        tags: ["#Chemistry", "#S6", "#ALevel"],
        date: "2024-12-18"
      },
      {
        id: 3,
        title: "S1 General Science",
        description: "Introduction to biology and environment studies. Complete diagrams on page 45-50.",
        tags: ["#Biology", "#S1", "#Junior"],
        date: "2024-12-20"
      },
      {
        id: 4,
        title: "S5 Mathematics - Calculus",
        description: "Advanced differentiation and integration techniques for science combinations.",
        tags: ["#Math", "#S5", "#ALevel"],
        date: "2024-12-22"
      },
      {
        id: 5,
        title: "S2 English Composition",
        description: "Creative writing prompts and grammar exercises focusing on past perfect tense.",
        tags: ["#English", "#S2", "#Literacy"],
        date: "2024-12-23"
      },
      {
        id: 6,
        title: "S4 Geography - Physical",
        description: "Detailed study of volcanicity and tectonic plates in East Africa.",
        tags: ["#Geography", "#S4", "#EarthScience"],
        date: "2024-12-24"
      }
    ];
      ...
      data.forEach((work, index) => {
        ...
        col.innerHTML = `
          <div class="work-card">
            ...
            <button class="btn-download" onclick="simulateDownload('${work.title}')">
              <i class="bi bi-cloud-arrow-down-fill me-2"></i>Download Work
            </button>
          </div>
        `;
    ...
    function simulateDownload(title) {
      ...
      msg.textContent = `Starting download for: ${title}`;
      toast.style.display = 'block';

      setTimeout(() => {
        msg.textContent = `Success! Check your downloads folder.`;
        setTimeout(() => {
