...
<body class="index-page">
    ...
    <section id="announcements" class="py-3">
        <div class="container">
            <div class="row">
                <?php
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<p class='date text-secondary'><strong>Posted:</strong> " . date('F j, Y - H:i', strtotime($row["uploaded_at"])) . "</p>";
                        echo "</div>";
                        echo "</div>";
                    }
                } else {
                    echo "<p class='text-center text-muted'>No announcements available at the moment. Stay tuned for updates!</p>";
                }
                ?>
            </div>
        </div>
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-2 col-md-3 footer-links">
                    ...
                    <ul>
                        ...
                        <li><a href="holidays_works.php" class="holidaywork">Holidaywork</a></li>
                        <li><a href="announcement.php" class="Announcement">Announcement</a></li>
                        <li><a href="news.php" class="news">News</a></li>
                    </ul>
                </div>
